...
namespace AxiomProfiler
{
    ...
    {
        public AxiomProfilerCore core = new AxiomProfilerCore();
        ParameterConfiguration parameterConfiguration => core.parameterConfiguration;
        public Model model => core.model;
        ...
        {
            return core.parseCommandLineArguments(args, out error);
        }
        ...
        private void loadModelFromZ3Logfile()
        {
            ...
            core.parameterConfiguration = loadform.GetParameterConfiguration();
            ParameterConfiguration.saveParameterConfigurationToSettings(parameterConfiguration);
